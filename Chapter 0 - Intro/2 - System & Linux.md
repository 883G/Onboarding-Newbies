...
> Note: while some environment uses `systemd` for service management, other init systems like **initd**, **OpenRC**, and **runit** exist and may be encountered in legacy or alternative distributions. Understanding the basic concept of an init system is more important than knowing the specific implementation.
