...
1.
 ...
 4. 
 daemon - תוכנה שרצה ברקע ללא תלות בחיבור של יוזר ספציפי ומטרתה לספק איזשהו שירות ה"אב" שלהם הוא הפרוסס איניט אבל ניתן ליצור כאלה ידנית. ההבדל העיקרי הוא ש daemons לא צריכים את המשתמש בכלל לעומת תהליך רגיל שצריך איזשהי אינרקציה, אפילו הכי בסיסית שיש עם המשתמש.
