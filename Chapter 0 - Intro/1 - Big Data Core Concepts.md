...
17. **Data lineage**
כלי שושלת נתונים מספקים תיעוד של המידע לאורך כל מחזור החיים שלו, כולל המידע הגולמי והשינויים שהתבצעו עליו במהלך הזרמתו.
התיעוד מאפשר לצפות ולעקוב על המידע בנקודות זמן שונות , ומאפשר לארגונים לאמת יותר את דיוק ועקביות המידע.

18. **Store‑first approach**
גישה שלפיה נשמר המידע באופן זהה לפורמט ולתכולה הגולמית שלו ללא שינוי.

19. **Data serialization**
זהו תהליך שבו ממירים נתונים מטיפוסים מורכבים או אובייקטים לפורמט מסוים של קובץ.

20. **Data compression**
תהליך שמטרתו להפחית את הגודל של קבצי נתונים דיגיטלים מבלי לשנות את תכולתם.

21. **Scale‑out vs. scale‑up**
Scale up- 
 הגדלת משאב קיים על מנת לשפר את ביצועי העיבוד / להגדיל את קיבולת האחסון
Scale out- הוספת משאבדים נוספים על מנת לשפר את ביצועי העיבוד /להגדיל את קיבולת האחסון
